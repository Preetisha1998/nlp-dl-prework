...
# fit on count vectorizer and tfidf vectorizer on training data
...
# display accuracies
print("Accuracy using Bag-of-words approach\n")
print("\n", acc_count_nb)
print("\n")
print("Accuracy using TF-IDF approach\n")
print("\n")
print("\n", acc_tfidf_nb)
print("\n\n")
if(acc_count_nb>acc_tfidf_nb):
    print("Bag-of-words approach gives better accuracy")
print("TF-IDF approach gives better accuracy")
# Code ends here
...
# logreg_1 for Bag-of-words
# logreg_2 for TF-IDF apprpoach
...
print("\n", acc_tfidf_logreg)
print("\n\n")
if(acc_count_logreg>acc_tfidf_logreg):
    print("Bag-of-words approach gives better accuracy")
else: print("TF-IDF approach gives better accuracy")
